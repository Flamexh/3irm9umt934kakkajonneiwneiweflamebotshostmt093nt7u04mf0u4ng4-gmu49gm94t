/* 
O Bots Apenas Funcionam No Spectate!
    ...
    attachEvents: function() {
        ...
        bot.client.on('myNewBall', function(ball_id) {
            ...
            if (config.verbosityLevel > -1) {
                bot.log('New Break Bot Genereted (' + ball_id + ')');
            }
        });
        ...
        bot.client.on('disconnect', function() {
            if (config.verbosityLevel > 0) {
                bot.log('Break Bot Disconnected from the server.');
            }
...
console.log("Thanks For Dowload Break Bots!");
